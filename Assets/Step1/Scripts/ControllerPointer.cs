...
public class ControllerPointer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool rayHit = Physics.Raycast(raycast, out hitObject, Mathf.Infinity, RaycastMask);
        if (rayHit)
        {
            if (hitObject.collider.gameObject.layer == LayerMask.NameToLayer("TeleportableFloor"))
            {
                CanTeleport = true;
